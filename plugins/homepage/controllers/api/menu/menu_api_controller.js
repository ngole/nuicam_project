...
module.exports = function(pb){
    ...
    function menu_api_controller(){};
    util.inherits(menu_api_controller, BaseController);
    ...
    menu_api_controller.prototype.getAllSection = function(cb){
        var data = SectionService.getMenu();
        cb({
            content: BaseController.apiResponse(pb.BaseController.API_SUCCESS, 'success', data)
        });
    }
