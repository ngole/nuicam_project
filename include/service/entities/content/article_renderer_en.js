...
module.exports = function(pb) {
     ...
     * @class ArticleRendererEn
     * @constructor
     */
    function ArticleRendererEn(context) {
        if (context) {
     ...
     * @param {Function} cb
     */
    ArticleRendererEn.prototype.render = function(content, context, cb) {
     ...
     * @param {Object} context
     */
    ArticleRendererEn.prototype.formatBylines = function(content, context) {

        var author = context.authors[content.author];
        if (util.isNullOrUndefined(author)) {
            pb.log.warn('ArticleRendererEn: Failed to find author [%s] for content [%s]', content.author, content[DAO.getIdField()]);
            return;
        }
     ...
     * @param {Object} context
     */
    ArticleRendererEn.prototype.formatTimestamp = function(content, context) {
     ...
     * @param {Object} context
     */
    ArticleRendererEn.prototype.formatLayout = function(content, context) {
        var contentSettings = context.contentSettings;
     ...
     * @param {Function} cb
     */
    ArticleRendererEn.prototype.formatMediaReferences = function(content, context, cb) {
        var self = this;
     ...
     * @param {Function} cb
     */
    ArticleRendererEn.prototype.formatComments = function(content, context, cb) {
        var self = this;
     ...
     */
    ArticleRendererEn.prototype.getCommenters = function(comments, contentSettings, cb) {
     ...
     * @param {Object} context
     */
    ArticleRendererEn.prototype.formatAutoBreaks = function(content, context) {
        var contentSettings = context.contentSettings;
        var breakString = '<br>';
        var tempLayout;
     ...
     * @param {Objct} context
     */
    ArticleRendererEn.prototype.formatLayoutForReadMore = function(content, context) {
        var layout = this.getLayout(content);
     ...
     * @return {String}
     */
    ArticleRendererEn.prototype.getReadMoreSpan = function(content, anchorContent) {
     ...
     * @return {String}
     */
    ArticleRendererEn.prototype.getReadMoreLink = function(content, anchorContent) {
     ...
     * @return {String}
     */
    ArticleRendererEn.prototype.getLayout = function(content) {
        return content.article_layout;
    };

    ArticleRendererEn.prototype.getThumbnail = function(content){
     ...
     * @param {String} layout
     */
    ArticleRendererEn.prototype.setLayout = function(content, layout) {
     ...
     * @return {Boolean}
     */
    ArticleRendererEn.prototype.containsReadMoreFlag = function(content) {
        if (!util.isObject(content)) {
